...
class ResultAndStadingsStandingsMotogpViewModel extends GetxController {
  ...
  RxList<Map<String, dynamic>> ridersListMotoGPWildCardsAndTestRiders =
      <Map<String, dynamic>>[].obs;
  RxList<Map<String, dynamic>> standingsMotoGP = <Map<String, dynamic>>[].obs;
  RxList<Map<String, dynamic>> standingsMotoGPAdd =
      <Map<String, dynamic>>[].obs;
...
// Temporary storage for rider details
  ...
  void onInit() {
    ...
    fetchStandingsMotoGP();
    fetchRidersStandingsMotoGPAdd();
    super.onInit();
  }
  ...
  Future<void> fetchStandingsMotoGP() async {
    DatabaseReference resultsRef = _databaseReference
        .child('Results&Standings/Standings/2024/RidersChampionship/MotoGP');
  ...
  Future<void> fetchRidersStandingsMotoGPAdd() async {
    DatabaseReference resultsRef = _databaseReference
        .child('Results&Standings/Standings/2024/RidersChampionship/MotoGPADD');
