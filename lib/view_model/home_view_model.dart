...
class HomeViewModel extends GetxController {
  ...
  RxList<Map<String, dynamic>> homeNews2024FIM =
      <Map<String, dynamic>>[].obs;
  RxList<Map<String, dynamic>> homeNews37Points =
      <Map<String, dynamic>>[].obs;
  RxList<Map<String, dynamic>> homeNewsBagnaiaGiven =
      <Map<String, dynamic>>[].obs;
  RxList<Map<String, dynamic>> homeNewsGoldenAi =
      <Map<String, dynamic>>[].obs;
  RxList<Map<String, dynamic>> homeNewsHasDucati =
      <Map<String, dynamic>>[].obs;
  ...
  Future<void> fetchHomeNews2024FIM() async {
    ...
    _databaseReference.child('News/New/2024 FIM MiniGP World Series Ambassadors revealed!');
  ...
  Future<void> fetchHomeNews37Points() async {
    DatabaseReference calendarRef =
    _databaseReference.child('News/New/37 points to survival of the fittest');
  ...
  Future<void> fetchHomeBagnaiaGiven() async {
    DatabaseReference calendarRef =
    _databaseReference.child('News/New/Bagnaia given three-place grid penalty for Sunday');
  ...
  Future<void> fetchHomeNewsGoldenAi() async {
    DatabaseReference calendarRef =
    _databaseReference.child('News/New/GoldenAi: Ai Ogura crowned 2024 Moto2™ World Champion');
  ...
  Future<void> fetchHomeHasDucati() async {
    DatabaseReference calendarRef =
    _databaseReference.child('News/New/Has Ducati boss revealed 2025 VR46 rider line up?');
  ...
  Future<void> fetchHomeNewsLetsTheGames() async {
    DatabaseReference calendarRef =
    _databaseReference.child('News/New/Let the games begin: The 2024 Global Series starts now!');
  ...
  Future<void> fetchHomeNewsMotoGPEngine() async {
    DatabaseReference calendarRef =
    _databaseReference.child('News/New/MotoGP™ engine specification frozen for 2026');
  ...
  Future<void> fetchHomeNewsWillBastianini() async {
    DatabaseReference calendarRef =
    _databaseReference.child('News/New/Will Bastianini’s momentum roll into Indonesia?');
  ...
  Future<void> fetchHomeNewsOliveiraUndergoes() async {
    DatabaseReference calendarRef =
    _databaseReference.child('News/New/Oliveira undergoes surgery on fractured wrist');
