            ...
            children: [
              ...
              Row(
                ...
                children: [
                  InkWell(
                      onTap: () {
                        Get.to(() => const RidersAndTeamsMainView(
                              initialIndex: 0,
                            ));
                      },
                      child:
                          _containerRiderAndTeam(ImageAssest.riders, 'Riders')),
                  const SizedBox(
                    width: 8,
                  ),
                  InkWell(
                      onTap: () {
                        Get.to(() =>
                            const RidersAndTeamsMainView(initialIndex: 1));
                      },
                      child:
                          _containerRiderAndTeam(ImageAssest.teams, 'Teams')),
                  const SizedBox(
                    width: 8,
                  ),
                  InkWell(
                      onTap: () {
                        Get.to(() =>
                            const RidersAndTeamsMainView(initialIndex: 2));
                      },
                      child: _containerRiderAndTeam(
                          ImageAssest.legends, 'Legends'))
                ],
              ),
              const SizedBox(
                height: 20,
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        top: 204,
                        left: 16,
                        child: _exploreMotoGP(
                            ImageAssest.motoGPAuthentic, 'MotoGP™ Authentics'),
                      ),
                      // Thêm các widget khác vào Stack nếu cần
                      Positioned(
                        top: 180, // Điều chỉnh vị trí của widget tiếp theo
